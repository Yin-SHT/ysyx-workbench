...
#define ALIGN_CPU                                                                                                               \
    do {                                                                                                                        \
        for (int i = 0; i < 32; i ++) {                                                                                         \
            cpu.gpr[i] = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu0__DOT__decode0__DOT__userreg0__DOT__UREGS[i];   \
        }                                                                                                                       \
        cpu.mstatus = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu0__DOT__decode0__DOT__sysreg0__DOT__mstatus;        \
        cpu.mcause  = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu0__DOT__decode0__DOT__sysreg0__DOT__mcause;         \
        cpu.mtvec   = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu0__DOT__decode0__DOT__sysreg0__DOT__mtvec;          \
        cpu.mepc    = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu0__DOT__decode0__DOT__sysreg0__DOT__mepc;           \
        cpu.pc      = top->rootp->ysyxSoCFull__DOT__asic__DOT__cpu__DOT__cpu0__DOT__fetch0__DOT__controller__DOT__pc;           \
    } while (0);
